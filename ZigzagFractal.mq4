...
int findFractalCandle(int nbr, int mode, int timeframe)
export {
	int i = 3, n;
	for (n = 0; n <= nbr; n++) {
		while (iFractals(Symbol(), timeframe, mode, i) == 0)
...
double findFractalWithCandleInput(int nbr, int mode, int timeframe, int candle)
export {
	int i = candle + 3, n;
	for (n = 0; n <= nbr; n++) {
		while (iFractals(Symbol(), timeframe, mode, i) == 0)
...
void TrailByFractal(double lastUpFractal, double lastDownFractal)
export
{
...
bool LastReversalFractalNotNear(int candle, string operation, int pips,
		int timeframe, bool includeLastSecond, bool includeOpposite)
export
{
...
bool ZigZagsIsNotNear(int candle, string operation, int timeframe, int pips,
		bool checkForLeglength, int legLength)
export
{

	bool ZigZagsIsNotNear =false;
	//Zigzag variables
	double LastUpZigZag, LastDownZigZag, LastSecondUpZigZag,
			LastSecondDownZigZag, LastThirdUpZigZag, LastThirdDownZigZag,
			LastUpZigZagMove, LastSecondUpZigZagMove, LastDownZigZagMove,
			LastSecondDownZigZagMove, LastZigZagMove, LastZigZag, LastDownZZ,
			LastUpZZ;
